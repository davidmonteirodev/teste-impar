...
| Documento | Descrição |
|-----------|-----------|
| **[semantic-documentation.md]** | Documentação semântica do sistema com entidades, regras de negócio e premissas |
| **[qa-documentation.md]** | Estratégia de qualidade, guia de testes e validações manuais |
| **[ai-test-executions.md]** | Registro de validações realizadas com apoio de Inteligência Artificial (GitHub Copilot) |
